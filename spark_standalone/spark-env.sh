...
export SPARK_MASTER_WEBUI_PORT="5186"
export SPARK_WORKER_WEBUI_PORT="5187"
...
export SPARK_HISTORY_FS_LOG_DIRECTORY="/opt/spark/spark-events"
export SPARK_LOG_LEVEL="ALL"
export SPARK_HISTORY_FS_CLEANER_ENABLED="0"

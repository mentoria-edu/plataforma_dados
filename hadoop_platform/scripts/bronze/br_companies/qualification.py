...
HUDI_OPTIONS = {
    ...
    "hoodie.datasource.write.recordkey.field": "id_qualification,_attribute_change_hash",
...
SCHEMA = StructType([
    StructField("id_qualification", StringType(), True),
...
def main() -> None:
    """Execute bronze layer ingestion pipeline for qualification data.
